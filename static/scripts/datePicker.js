...
(function ($) {
    ...
    var default_options  = {
        ...
        format:'Y/m/d', // modified by kevin .the default valus is  'Y/m/d H:i',
        formatTime:	'H:i',
        formatDate:	'Y/m/d',

        startDate:false,//false, // new Date(), '1986/12/08', '-1970/01/05','-1970/01/05',
        step: 60,
        ...
        minDate: new Date(),//false  modified by kevin .defult value is false
        maxDate: false,
        minTime: false,
        maxTime: false,
