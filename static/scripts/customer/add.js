...
$(function(){
    ...
    var curHospitalLevel= $("#hospitalLevelId").attr('data-subvalue');
    var curHospitalGradesl= $("#hospitalGradesId").attr('data-subvalue');

    $("#hospitalGradesId").append("<option value=\"\" selected=\"selected\">"+ curHospitalGradesl +"</option>");
